...
public class ValidateUtil {
  ...
  public static String createJsonForAllRequest() {
    var classSet = ClassUtil.listClasses("com.uchicom.tracker.dto.request");
    classSet.addAll(ClassUtil.listClasses("com.uchicom.tracker.dto.request.account"));
    classSet.addAll(ClassUtil.listClasses("com.uchicom.tracker.dto.request.issue"));
