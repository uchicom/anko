...
import com.uchicom.anko.annotation.Auth;
import com.uchicom.anko.annotation.Path;
import com.uchicom.anko.api.AbstractApi;
import com.uchicom.anko.api.AccountApi;
import com.uchicom.anko.api.MemoApi;
import com.uchicom.anko.dto.response.account.AuthDto;
import com.uchicom.anko.exception.ViolationException;
import com.uchicom.anko.module.MainModule;
import com.uchicom.anko.service.DateTimeService;
import com.uchicom.anko.util.AuthUtil;
import com.uchicom.anko.util.ClassUtil;
import com.uchicom.anko.util.ValidateUtil;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      get("/anko/js/validation.js", (req, res) -> createJs(res, createValidationPage()));
      apiPackage("com.uchicom.anko.api", "/anko/api");
      path(
          "/anko",
          () -> {
            get(
                ...
                (req, res) -> {
                  ...
                  return readFile(file, "anko/user.htm");
                });
          });
    } catch (Exception e) {
  ...
  String execute(Class<AbstractApi> apiClass, Method method, Request req, Response res)
    ...
    try {
      ...
      if (auth != null && !AuthUtil.auth(req, dateTimeService.getLocalDateTime(), auth.value())) {
