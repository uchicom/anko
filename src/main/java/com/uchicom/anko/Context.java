...
public class Context {
  ...
  private Context() {
    // Hikari設定
    logger.info(System.getProperty("com.uchicom.anko.db", "src/main/resources/db.properties"));
    dbProperties =
        ResourceUtil.createProperties(
            new File(System.getProperty("com.uchicom.anko.db", "src/main/resources/db.properties")),
            "UTF-8");
    // 設定
    logger.info(
        System.getProperty("com.uchicom.anko.config", "src/main/resources/config.properties"));
    configProperties =
        ResourceUtil.createProperties(
            new File(
                System.getProperty(
                    "com.uchicom.anko.config", "src/main/resources/config.properties")),
            "UTF-8");
  }
